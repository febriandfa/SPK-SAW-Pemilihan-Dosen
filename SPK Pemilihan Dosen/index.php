...
?>	
	...
	<div class="container">
	  <h1 class="display-5 text-center" id="judul">
	  	  Sistem Pendukung Keputusan Metode SAW <br>Pemilihan Dosen Terbaik
      </h1>
      <p style="text-align:center;">
        <img src="/assets/images/dosen.jpg" alt="Dosen" class="center">
      </p>
	...
	<br>
    <h1 class="display-5 text-center" id="garfik">
